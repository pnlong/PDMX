...
# The vocabularies used for arrival-time and interarrival-time encodings. Copied from AMT codebase

# python /home/pnlong/model_musescore/amt_vocab.py

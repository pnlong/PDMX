...
# function to parse musescore (.mscz) files and extract any expressive features, outputting them as tokens

# python /home/pnlong/model_musescore/extract_expressive_features.py
...
METADATA_MAPPING_FILEPATH = f"{OUTPUT_DIR}/metadata_to_data.csv"
ERROR_MESSAGE_OUTPUT_FILEPATH = f"{OUTPUT_DIR}/read_mscz_errors.csv"
TIMING_OUTPUT_FILEPATH = f"{OUTPUT_DIR}/read_mscz_timing.txt"
MAPPING_OUTPUT_FILEPATH = f"{OUTPUT_DIR}/expressive_features.csv"
NA_STRING = "NA"
